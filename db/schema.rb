...
ActiveRecord::Schema.define(version: 20190427034544) do
  ...
  create_table "batches", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["batchable_type", "batchable_id"], name: "index_batches_on_batchable_type_and_batchable_id"
  ...
  create_table "template_updates", force: :cascade do |t|
    t.string "behavior"
    t.text "ids"
  ...
  create_table "xml_imports", force: :cascade do |t|
    t.string "metadata_file"
