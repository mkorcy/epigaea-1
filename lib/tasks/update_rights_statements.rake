  ...
  task update_rights_statements: :environment do
    if ARGV.size != 2
      ...
      updates_hash = {
        ...
        'http://rightsstatements.org/page/1.0/?language=en'                 => 'http://rightsstatements.org/vocab/InC/1.0/',
        ...
        'http://rightsstatements.org/page/1.0/'                             => 'http://rightsstatements.org/vocab/InC/1.0/',
        'http://rightsstatements.org/page/InC/1.0/'                         => 'http://rightsstatements.org/vocab/InC/1.0/',
        'http://rightsstatements.org/page/InC-EDU/1.0/'                     => 'http://rightsstatements.org/vocab/InC-EDU/1.0/',
        'http://rightsstatements.org/page/InC-NC/1.0/'                      => 'http://rightsstatements.org/vocab/InC-NC/1.0/',
        'http://rightsstatements.org/page/InC-RUU/1.0/'                     => 'http://rightsstatements.org/vocab/InC-RUU/1.0/',
        'http://rightsstatements.org/page/NoC-US/1.0/'                      => 'http://rightsstatements.org/vocab/NoC-US/1.0/',
        'http://rightsstatements.org/page/CNE/1.0/'                         => 'http://rightsstatements.org/vocab/CNE/1.0/',
        'http://rightsstatements.org/page/UND/1.0/'                         => 'http://rightsstatements.org/vocab/UND/1.0/',
        'http://rightsstatements.org/page/NKC/1.0/'                         => 'http://rightsstatements.org/vocab/NKC/1.0/',
